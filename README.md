...
Двойная валидация: Flow → Depth Map + ArUco → 6DoF позиция. Бакалаврская работа по компьютерному зрению.
...
| Файл       | Назначение                                              |
| ---------- | ------------------------------------------------------- |
| main.cpp   | Optical Flow + ArUco + GUI (два окна: original/depth)   |
| calibration.cpp | Калибровка камеры  |
